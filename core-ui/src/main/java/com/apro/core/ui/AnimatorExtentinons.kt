...
fun View.fadeIn(duration: Long = 300L): ViewPropertyAnimator = animate().alpha(1f).setDuration(duration)


fun View.fadeOut(duration: Long = 300L): ViewPropertyAnimator = animate().alpha(0f).setDuration(duration)


fun View.show(show: Boolean, duration: Long = 300L) {
  isVisible = true
